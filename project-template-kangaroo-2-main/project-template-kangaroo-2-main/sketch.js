...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    //Resetting the kangaroo's animation
   ...
   console.log(kangaroo.y)
    ...
    //Revealing the gameOver image and restart button
    gameOver.visible=true;
    restart.visible=true;

    //If condition for restarting the game
    if (mousePressedOver(restart)){
      ...
      //Destroying the remaining obstacles and shrubs
      obstaclesGroup.destroyEach();
      shrubsGroup.destroyEach();

      //Resetting the visibility of gameOver and restart
      gameOver.visible=false;
      restart.visible=false;
